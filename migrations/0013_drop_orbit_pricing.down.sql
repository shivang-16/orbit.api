...
ALTER TABLE model_pricing
    ADD COLUMN IF NOT EXISTS orbit_input_per_million_micros BIGINT NOT NULL DEFAULT 0,
    ADD COLUMN IF NOT EXISTS orbit_output_per_million_micros BIGINT NOT NULL DEFAULT 0;
