...
INSERT INTO model_catalogue (
    ...
    ('Llama 4 Scout 17B', 'llama-4-scout-17b', 'meta', 'bedrock', 'arn:aws:bedrock:us-east-1:471112741644:inference-profile/us.meta.llama4-scout-17b-instruct-v1:0', 10000000, 2, ARRAY['long-context','cost-efficient']::text[], ARRAY['text','image']::text[], true),
