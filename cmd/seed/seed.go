...
var models = []catalogueModel{
	{
		...
		Vendor:            "anthropic",
		Provider:          "bedrock",
		ModelID:           "arn:aws:bedrock:us-east-1:471112741644:inference-profile/global.anthropic.claude-fable-5-1",
	...
	},
	{
		...
		Vendor:            "openai",
		Provider:          "bedrock",
		ModelID:           "arn:aws:bedrock:us-east-1:471112741644:inference-profile/global.openai.gpt-6-astra",
		InputContextLimit: 1_000_000,
		SortOrder:         0,
		Tier:              "flagship",
		ExtraTags:         []string{"reasoning", "coding", "agentic"},
