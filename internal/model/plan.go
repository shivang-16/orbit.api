...
type Plan struct {
	...
	MaxOrganizations *int           `json:"max_organizations,omitempty" db:"max_organizations"`
	MaxMembersPerOrg *int           `json:"max_members_per_org,omitempty" db:"max_members_per_org"`
